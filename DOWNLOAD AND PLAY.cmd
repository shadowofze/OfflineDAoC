...
echo This downloads Offline DAoC v0.32b - Darkness Falls Beta with optional Sluaghbinder.
echo It verifies a normal v0.32 base and patches only a NEW sibling playable folder.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0Get-OfflineDAoC.ps1" -ReleaseVersion 0.32b
if errorlevel 1 (
