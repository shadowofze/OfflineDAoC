...
if ($manifest.Mode -eq 'delta') {
    ...
    if (!(Test-Path -LiteralPath $worldPatcher -PathType Leaf) -or
        ...
        throw 'The downloaded v0.31 base update is missing its Shannon Estuary world patch. Use the latest v0.31 release manifest and update asset.'
    }
    ...
    if ($worldPatchProcess.ExitCode -ne 0) {
        throw 'The Shannon Estuary world patch failed in the new v0.31 base copy. The original installation was not changed.'
    }
