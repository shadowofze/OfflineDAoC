...
Both current v0.31 and v0.31b offer repeatable Bounty Masters in Cotswold,
...
- [LLM guide to the optional Sluaghbinder pet textures](https://github.com/shadowofze/OfflineDAoC/blob/release/v0.31b-sluaghbinder/docs/LLM-SLUAGHBINDER-PET-TEXTURES.md): private NIF/DDS registrations, legacy MPK rules, visual testing, and rollback. The maintained optional-class source is on the [v0.31b branch](https://github.com/shadowofze/OfflineDAoC/tree/release/v0.31b-sluaghbinder).
