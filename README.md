...
The latest `OfflineDAoC-v0.31-bard-guard-update.zip` includes the Bard
PvE mez and Shannon Estuary beach-rat repairs, plus a solo Bard gamebot
disconnect fix. The helper selects it automatically through the release
manifest. Earlier update ZIPs remain available.
