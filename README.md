...
| Normal game **plus** the optional Hibernian Sluaghbinder class | The **v0.31b** release's `DOWNLOAD AND PLAY v0.31b.cmd` helper, or the latest `Sluaghbinder-v0.31b-bard-guard-patch.zip` | Downloads a v0.31 baseline, makes a separate copy, and installs Sluaghbinder there. The original v0.3/v0.31 folder is never changed. |
...
the latest `Sluaghbinder-v0.31b-bard-guard-patch.zip` asset from the [v0.31b release](https://github.com/shadowofze/OfflineDAoC/releases/tag/v0.31b)
