...
// Long Old Frontiers corridors can exhaust 4096 search nodes and repeatedly
// return the same dead-end partial path. Keep output buffers unchanged; only
// the bounded A* search pool grows. All 81 classic realm/keep routes validate
// with 16384, including both remote portal approaches and the relic keeps.
constexpr auto MAX_NODES = 16384;
