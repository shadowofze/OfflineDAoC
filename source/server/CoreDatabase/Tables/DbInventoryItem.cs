...
namespace DOL.Database
{
	...
	public class DbInventoryItem : DataObject
	{
        ...
        private string _realmExchangeListedUtc = string.Empty;
        [DataElement(AllowDbNull = true)]
        public string RealmExchangeListedUtc
        {
            get => _realmExchangeListedUtc;
            set { Dirty = true; _realmExchangeListedUtc = value; }
        }
		...
		protected DbInventoryItem(DbInventoryItem dbInventoryItem)
		{
            ...
            _realmExchangeListedUtc = dbInventoryItem.RealmExchangeListedUtc;
		}

        // Preserve identity and every scalar field, unlike Clone(), which creates
        // a new item ID. The background bot writer must not serialize an actor's
        // live item while removal/equipment changes are clearing its owner.
        public DbInventoryItem CreatePersistenceSnapshot() => (DbInventoryItem)MemberwiseClone();
