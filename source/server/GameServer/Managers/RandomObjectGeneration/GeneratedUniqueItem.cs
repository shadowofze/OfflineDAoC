...
namespace DOL.GS
{
    ...
    public class GeneratedUniqueItem : DbItemUnique {
        ...
        private bool SkillIsValidForClass(eProperty property)
        {
            switch (charClass)
            {
                // Base classes need explicit smart-loot coverage too.  Without
                // these cases a new character falls through to cloth/staff and
                // receives bonuses for no usable line until promotion.
                case eCharacterClass.Fighter:
                    return property == eProperty.Skill_Parry ||
                ...
                case eCharacterClass.Acolyte:
                    return property == eProperty.Skill_Crushing ||
                           ...
                           property == eProperty.AllSkills;
                case eCharacterClass.AlbionRogue:
                    return property == eProperty.Skill_Slashing ||
                           property == eProperty.Skill_Thrusting ||
                           property == eProperty.AllMeleeWeaponSkills ||
                           property == eProperty.AllSkills;
                case eCharacterClass.Mage:
                case eCharacterClass.Elementalist:
                    return property == eProperty.AllFocusLevels ||
                           property == eProperty.AllMagicSkills ||
                           property == eProperty.AllSkills;
                case eCharacterClass.Viking:
                    return property == eProperty.Skill_Parry ||
                           ...
                           property == eProperty.AllSkills;
                case eCharacterClass.Seer:
                    return property == eProperty.Skill_Hammer ||
                           property == eProperty.Skill_Staff ||
                           property == eProperty.Skill_Shields ||
                           property == eProperty.AllMeleeWeaponSkills ||
                           property == eProperty.AllMagicSkills ||
                           property == eProperty.AllSkills;
                case eCharacterClass.MidgardRogue:
                    return property == eProperty.Skill_Sword ||
                           property == eProperty.Skill_Axe ||
                           property == eProperty.AllMeleeWeaponSkills ||
                           property == eProperty.AllSkills;
                case eCharacterClass.Mystic:
                ...
                case eCharacterClass.Guardian:
                    return property == eProperty.Skill_Parry ||
                           ...
                           property == eProperty.AllSkills;
                case eCharacterClass.Naturalist:
                    return property == eProperty.Skill_Blunt ||
                           property == eProperty.Skill_Blades ||
                           property == eProperty.Skill_Staff ||
                           property == eProperty.Skill_Shields ||
                           property == eProperty.AllMeleeWeaponSkills ||
                           ...
                           property == eProperty.AllSkills;
                case eCharacterClass.Stalker:
                    return property == eProperty.Skill_Blades ||
                           property == eProperty.Skill_Piercing ||
                           property == eProperty.Skill_RecurveBow ||
        ...
        public static eObjectType GetAlbionWeapon(eCharacterClass charClass)
        {
			...
			*/
            switch (charClass)
            {
                // Starter-class choices mirror the weapons issued by their
                // trainers. This keeps level 1-4 player loot usable before the
                // player chooses an advanced class.
                case eCharacterClass.Fighter:
        ...
        public static eObjectType GetMidgardWeapon(eCharacterClass charClass)
        {
			...
			*/
            switch (charClass)
            {
                // Match each starter trainer's guaranteed practice weapon.
                case eCharacterClass.Viking:
