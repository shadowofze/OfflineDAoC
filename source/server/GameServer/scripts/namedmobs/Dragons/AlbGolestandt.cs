...
namespace DOL.GS
{
	public class AlbGolestandt : GameEpicBoss
	{
		...
		public override void LoadFromDatabase(DataObject obj)
		{
			...
			DragonLairPlacement.Restore(this, eRealm.Albion);
		...
		{
            if (Brain is AlbGolestandtBrain encounterBrain) encounterBrain.EncounterAdds.Reset();
				// debug
				if (killer == null)
		...
		private static readonly Point3D spawnPoint = DragonLairPlacement.Home(eRealm.Albion);
...
namespace DOL.AI.Brain
{
    public class AlbGolestandtBrain : StandardMobBrain
	{
			...
			: base()
		{
			...
			_roamingPathPoints.Add(DragonLairPlacement.Home(eRealm.Albion));//grounded lair
...
namespace DOL.AI.Brain
{
	public class GolestandtSpawnedAdBrain : DragonEncounterAddBrain
	{
		private static readonly Logging.Logger log = Logging.LoggerManager.Create(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
