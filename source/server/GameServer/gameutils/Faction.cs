...
namespace DOL.GS
{
    public class Faction
    {
        ...
        /// <summary>
        /// Gets the standing a newly encountered player has before any personal
        /// faction changes. Persistent bots do not have a GamePlayer faction
        /// ledger, so natural mob aggro uses this same initial standing.
        /// </summary>
        public Standing GetDefaultStanding()
        {
            return GetStanding(_baseAggroLevel);
        }

        private static Standing GetStanding(int aggro)
        {
            if (aggro > 75)
