...
namespace DOL.GS
{
    public class MarketSearch
    {
        ...
        /// <summary>
        /// The realm broker is isolated by its owner lot, not an item's original
        /// realm (neutral items are usable too). Apply the native filters before
        /// pagination without the housing market's unrelated 300-result cutoff.
        /// </summary>
        public List<DbInventoryItem> FindExchangeItems(SearchData search, ushort ownerLot)
        {
