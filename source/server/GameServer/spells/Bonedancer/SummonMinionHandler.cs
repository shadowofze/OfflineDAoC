...
namespace DOL.GS.Spells
{
    ...
    public class SummonMinionHandler : SummonSpellHandler
    {
        ...
        {
            // GameBots use the same commander-owned subordinate path as a real
            // Bonedancer. Ordinary NPC casters keep their legacy handling.
            if (Caster is GamePlayer or GameBot)
            {
                GamePlayer playerCaster = Caster as GamePlayer;
                IControlledBrain controlledBrain = Caster.ControlledBrain;
                ...
                int newPetLevel = AutonomousPetSupport.BonedancerSubPetLevel(Caster.Level, m_spell);
