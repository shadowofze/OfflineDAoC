...
namespace DOL.GS.Spells
{
	...
	public abstract class PropertyChangingSpell : SpellHandler
	{
		...
		{
			// Savage self-buffs settle their health cost when the effect expires.
			// Charging every PropertyChangingSpell to mana here made bot Savages
			// lose power for a health-cost ability and left them unable to execute
			// their real melee/buff rotation. Other cost types own their settlement.
			if (CostType == SpellCostType.Power)
