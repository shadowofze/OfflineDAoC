...
namespace DOL.GS
{
	...
	public class GameMerchant : GameNPC
	{
        ...
        {
            // Teleport merchants select their live trade list in their own
            // AddToWorld override, before arriving here.
            FrontierSupplyMerchantPolicy.ApplyLabel(this);
		...
		public virtual void OnPlayerSell(GamePlayer player, DbInventoryItem item)
		{
			...
			if (!FrontierSupplyMerchantPolicy.CanSell(item))
			{
