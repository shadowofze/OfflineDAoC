    ...
    public class DamageShieldECSEffect : ECSGameSpellEffect
    {
        ...
        private class CombatCheckTimer : ECSGameTimerWrapperBase
        {
            ...
            protected override int OnTick(ECSGameTimer timer)
            {
                ...
                // Keep focus during a live pull, not for a retained order to a corpse.
                ...
                if (_brain.Body.CurrentSpeed > 0 ||
                    _brain.OrderedAttackTarget is { IsAlive: true, ObjectState: GameObject.eObjectState.Active })
                {
                    // Remember combat permanently. Resetting this latch after
                    // combat meant a dead order could keep focus alive forever.
                    return Interval;
                }
