...
namespace DOL.GS.PacketHandler
{
    ...
    public interface IPacketLib
    {
        ...
        void SendObserverFlightMode(bool flying, bool debugEnabled) => SendDebugMode(debugEnabled);
        ...
        void SendMinotaurRelicMapRemove(uint id);
        void SendMinotaurRelicMapUpdate(uint id, ushort region, int x, int y, int z);
