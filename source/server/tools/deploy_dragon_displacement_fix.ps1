...
Assert-Stopped
$backup = Join-Path $runtime ('rollback-dragon-displacement-' + (Get-Date -Format 'yyyyMMdd-HHmmss'))
...
Write-Output "Installed and verified server DLL/PDB, root and lib. Rollback: $backup"
