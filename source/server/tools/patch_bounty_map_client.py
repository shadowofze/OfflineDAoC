...
# Previous public v0.31b payload, after its existing dungeon/bot-map hooks.
# A clean v0.3/v0.31 client is not this patch's direct input: the optional
# installer ships a prepared payload and validates the selected client.
SUPPORTED_SOURCE_SHA256 = {
    '691a457c0eb564c7ca6964e39015bd5df35c2a7965729d1572add2211c37ac78',
}
...
def build_patch(original):
    ...
    if source_hash not in SUPPORTED_SOURCE_SHA256:
        raise ValueError(f'Unverified game.dll build {source_hash}; refusing to patch')
